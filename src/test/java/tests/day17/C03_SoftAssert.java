 ...
 */
        ...
        softAssert.assertAll();//softAssert, bitirmek icin kullanlır
        System.out.println("hata vrasa burası calısmaz");
        //assertAll kadar Faile de olsa kod çalışıyor ve programı durdurmuyor,
