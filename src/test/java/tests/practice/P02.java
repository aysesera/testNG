...
// 5. Açılır pencereyi kabul edin
    ...
    public void test01() {
      ...
      //  Assert.assertTrue(actualText.contains(expectedText));//icerdigini dogrulayın derse true kullanlırı ama buntestte  equls daha iyi
// 5. Açılır pencereyi kabul edin
        driver.switchTo().alert().accept();//accept kabul et
    }
}
