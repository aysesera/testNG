...
public class DhtmlgoodiesPage {
    public DhtmlgoodiesPage() {
        ...
        //java da bir class obje creat etmek icin cons kullanmak lazım
        //pagefactory selenıum da page object model kullanılcaksa pagefactory cagırlılır
        //this ile framework teki daha once olusturdugum driverim burayla ilşkilendir
        /*
        neden pom
